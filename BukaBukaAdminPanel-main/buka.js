...
// Create a function that makes a POST request to buka's wake up API endpoint
  async function wakeUP() {
    let response = await fetch (ENDPOINT+"api/wakeup", {
      method "POST",
      mode: "no-cors"
    }
...
async function postData(url = "https://buka-buka.onrender.com", data = {}) {
